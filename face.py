...
while (time.time() - start_time) < loop_duration:
    ...
    # Counter of time passed every second
    current_time = time.time() - start_time
    print("Time passed:", int(current_time), "seconds")
...
detect_face = detect_face and (detected_name != "Unknown")
print("Detect Face:", detect_face)
